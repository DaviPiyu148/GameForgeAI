...
const HomePage = () => {
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center py-6 px-4">
      {/* 1. Hero Section */}
      <section className="mx-auto flex flex-col items-center text-center max-w-4xl space-y-6 mt-4 mb-10">
        {/* Status Pill */}
      ...
      <section className="w-full max-w-3xl mx-auto mb-4">
        <form onSubmit={handleSubmit} className="bg-terminal-bg rounded-lg glow-box-cyan overflow-hidden shadow-2xl">
          {/* Header bar */}
          ...
          <div className="p-4 sm:p-5 flex items-center gap-3 bg-terminal-bg">
            ...
            <div className="flex items-center gap-2 shrink-0">
              <button
                ...
                className={`p-2 transition-colors flex items-center justify-center rounded cursor-pointer ${
                  isListening ? 'text-secondary text-glow-magenta' : 'text-on-surface-variant hover:text-primary'
                }`}
              >
              ...
              <button
                type="submit"
                className="px-4 py-2 bg-primary text-on-primary font-mono text-xs sm:text-sm font-bold uppercase rounded hover:bg-primary-bright transition-all shadow-[0_0_12px_rgba(76,224,210,0.4)] flex items-center gap-1.5 cursor-pointer active:scale-95"
              >
                <span>Enter</span>
      ...
      {/* 3. Suggestion Chips */}
      <section className="flex flex-wrap items-center justify-center gap-3 w-full max-w-3xl mx-auto mb-16 sm:mb-20">
        <button
          type="button"
          onClick={() => handleChipClick('Cozy farming + exploration')}
          className="border border-secondary text-secondary font-mono text-xs px-3.5 py-1.5 rounded-full hover:bg-secondary/10 transition-colors cursor-pointer inline-flex items-center gap-1.5 active:scale-95"
        >
        ...
        <button
          ...
          className="border border-tertiary text-tertiary font-mono text-xs px-3.5 py-1.5 rounded-full hover:bg-tertiary/10 transition-colors cursor-pointer inline-flex items-center gap-1.5 active:scale-95"
        >
      ...
      <section className="w-full max-w-5xl mx-auto mt-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Card 1 */}
          <div className="bg-terminal-bg rounded-lg p-6 glow-box-cyan flex flex-col items-start transition-colors">
            <div className="w-12 h-12 rounded-lg bg-terminal-header border border-primary/40 flex items-center justify-center mb-5 shrink-0">
          ...
          {/* Card 2 */}
          <div className="bg-terminal-bg rounded-lg p-6 glow-box-magenta flex flex-col items-start transition-colors">
            <div className="w-12 h-12 rounded-lg bg-terminal-header border border-secondary/40 flex items-center justify-center mb-5 shrink-0">
          ...
          {/* Card 3 */}
          <div className="bg-terminal-bg rounded-lg p-6 glow-box-amber flex flex-col items-start transition-colors">
            <div className="w-12 h-12 rounded-lg bg-terminal-header border border-tertiary/40 flex items-center justify-center mb-5 shrink-0">
