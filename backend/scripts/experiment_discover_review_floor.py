...
STANDARD_BENCHMARK_PATH = Path(__file__).resolve().parent.parent / "tests" / "data" / "discovery_benchmark.json"
EXPLORATORY_BENCHMARK_PATH = Path(__file__).resolve().parent.parent / "tests" / "data" / "discover_exploratory_benchmark.json"
CATALOG_PATH = Path(__file__).resolve().parent.parent / "data" / "processed" / "games_catalog.json"
OUTPUT_PATH = Path(__file__).resolve().parent.parent / "data" / "discover_review_floor_experiment_results.json"
