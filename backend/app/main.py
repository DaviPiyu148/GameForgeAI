...
from app.api.project_inspirations import router as project_inspirations_router
...
app.include_router(project_inspirations_router, prefix="/api")  # Step 2: /api/projects/{id}/inspirations
