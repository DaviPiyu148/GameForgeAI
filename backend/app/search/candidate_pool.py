...
# DISCOVER: 87,890 reviewed-only long tail with 80% low-review confidence floor
# HIDDEN_GEMS: 87,890 reviewed-only long tail for discovery with 0% unreviewed noise (T150)
